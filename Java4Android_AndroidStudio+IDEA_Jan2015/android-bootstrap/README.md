...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-yourapp-package-appp2.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-yourapp-package-appp2)

This repository contains the source code for the [Appp2](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.yourapp.package.appp2).

Please see the [issues](https://github.com.yourapp.package.appp2/com-yourapp-package-appp2/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Appp2? Ask away on the [com-yourapp-package-appp2 discussion forum](https://groups.google.com/forum/#!forum/com-yourapp-package-appp2).

<a href="https://play.google.com/store/apps/details?id=com.yourapp.package.appp2" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.yourapp.package.appp2__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.yourapp.package.appp2__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.yourapp.package.appp2.R__) will now be renamed
...
signed with a different key.  Manually uninstall Appp2 from your device and
...
Appp2 is a result of a template project I've developed over the years as well as
...
Appp2 is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.yourapp.package.appp2/com-yourapp-package-appp2/contributors) on
...
[pull requests](https://github.com.yourapp.package.appp2/com-yourapp-package-appp2/pulls).
